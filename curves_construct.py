...
# # load data_v
data_v = np.loadtxt("ground_truth_08_14_20.csv", delimiter=',')
...
profiles = 30  # *** is there a good way to extract this from the data_v array? ***
...
# split the data_v into a dictionary of scan profiles for curve fitting
